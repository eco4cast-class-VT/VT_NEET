...
sd_obs_SRER_sub <- sd_obs_SRER_sub*8
...
```{r}
ggplot() +
  geom_point(data = temp_data_BART_sub, aes(x = seq(1, length(temp_data_BART_sub$temp)), y = temp, color = "1")) +
  geom_point(data = temp_data_KONZ_sub, aes(x = seq(1, length(temp_data_BART_sub$temp)), y = temp, color = "2")) +
  geom_point(data = temp_data_OSBS_sub, aes(x = seq(1, length(temp_data_BART_sub$temp)), y = temp, color = "3")) +
  geom_point(data = temp_data_SRER_sub, aes(x = seq(1, length(temp_data_BART_sub$temp)), y = temp, color = "4")) +
  scale_color_manual(values = plot_colors, labels = c("BART", "KONZ", "OSBS", "SRER")) +
  theme_bw()
```
