...
tempfc <- subset(tempfc, tempfc$runEndDate == "2021-04-05T00")
...
#write.csv(temp_fc, file = "temp_fc.csv", row.names=F)
```
...
dat_fun <- function(dat){
  ...
  dat3 <- tibble(as.character(rep(dat[1,1], 840)),
                 ...
                 seq(ymd_hm("2021-03-01 0:30"), ymd_hm("2021-04-04 23:30"), by = "hour"),
...
write.csv(temp_dat, file = "temp_fc30.csv", row.names = F)
```
