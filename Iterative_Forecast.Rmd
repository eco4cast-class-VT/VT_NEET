...
plot_chain_TempDLM_BART = GetChainStats(chain_TempDLM_BART)
PlotTemperatureDLMvsObs(site = "BART", plot_chain_TempDLM_BART, target_data_BART_sub)

plot_chain_TempDLM_KONZ = GetChainStats(chain_TempDLM_KONZ)
PlotTemperatureDLMvsObs(site = "KONZ", plot_chain_TempDLM_KONZ, target_data_KONZ_sub)

plot_chain_TempDLM_OSBS = GetChainStats(chain_TempDLM_OSBS)
