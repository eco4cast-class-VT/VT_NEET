...
# source("https://raw.githubusercontent.com/PecanProject/pecan/develop/modules/uncertainty/R/flux_uncertainty.R")  # Will attempt to use flux_uncertainty function from PEcAn project later
...
PlotChain = function(siteID, nimbleOutput, burnin = 2000)
{
  ...
  # Exclude burn-in:
  nimbleMinusBurn <- window(nimbleOutput, start = burnin_TempDLM_SRER)
...
write.csv(NEE_forecast, file = "terrestrial_30min-2021-03-01-VT_NEET.csv", row.names = FALSE)
```
